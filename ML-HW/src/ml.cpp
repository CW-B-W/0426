...
int main(int argc, char* argv[])
{
    ...
    fc_weights_filepath.emplace_back("data/weights/Linear(in_features=42, out_features=5, bias=False).csv");

//     fc_weights_filepath.emplace_back("data/weights/Linear(in_features=42, out_features=9, bias=False).csv");
